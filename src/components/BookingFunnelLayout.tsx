  ...
  if (embedded) {
    return (
      <div className="w-full text-slate-200 font-mono">
        ...
        <div className="bg-[#111218]/40 border border-emerald-500/10 rounded-lg overflow-hidden p-4">
          {submitted ? (
            <div className="flex flex-col items-center text-center gap-4 py-6 animate-fade-in">
              ...
              <div className="bg-[#0c0d12] border border-[#1e2028] rounded-xl p-3 w-full max-w-md text-left space-y-2.5 text-[11px]">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                {/* Day Carousel */}
                <div className="relative flex items-center gap-1.5 bg-[#0c0d12] border border-[#1e2028] p-2 rounded-xl">
                  <button
                    type="button"
                      ...
                      <button
                        ...
                        className={`py-1.5 px-0.5 text-center rounded-lg border flex flex-col items-center justify-center transition cursor-pointer ${
                          selectedDate === day.dateStr
                            ...
                            : 'bg-[#111218] hover:bg-[#1a1b24] border-[#1e2028] text-slate-300'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`py-2 px-1 text-center rounded-lg border text-[10px] font-bold transition cursor-pointer ${
                          selectedTime === slot
                            ...
                            : 'bg-[#0c0d12] hover:bg-[#13141e] border-[#1e2028] text-slate-300'
                        }`}
                      >
                        {formatTimeSlot(slot)}
                      </button>
              ...
              {/* CUSTOMER INFO AND VEHICLE STATE */}
                ...
                <div className="space-y-4 pt-3 border-t border-white/5 animate-fade-in">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 px-2.5 py-2 text-[11px] text-white focus:outline-none"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-1.5">
                      <input
                        ...
                        className="rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 px-2 py-1.5 text-[11px] text-white focus:outline-none"
                        placeholder="Year"
                      />
                      <input
                        type="text"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 px-2.5 py-2 text-[11px] text-white focus:outline-none resize-none"
                  ...
                  <div className="bg-[#0c0d12] border border-emerald-500/20 p-3 rounded-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 text-[11px]">
                    <div>
  ...
  return (
    <div className="min-h-screen bg-[#07070a] text-slate-200 selection:bg-emerald-500/30 selection:text-white pb-16">
      ...
      <main className="max-w-3xl mx-auto px-4 mt-8 space-y-6">
        {/* Funnel Copy Box */}
        <section className="bg-[#111218] border-2 border-emerald-500/20 rounded-lg overflow-hidden shadow-2xl animate-fade-in p-6">
          <div className="space-y-3 font-mono">
            {funnel.service_type && (
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[11px] font-black uppercase tracking-widest border-2 bg-emerald-500 text-black border-emerald-400">
                {funnel.service_type}
              </span>
            )}
        ...
        {/* Dynamic Booking flow */}
        <section className="bg-[#111218] border-2 border-emerald-500/20 rounded-lg shadow-2xl overflow-hidden p-6 font-mono">
          {submitted ? (
            <div className="flex flex-col items-center text-center gap-4 py-8 animate-fade-in">
              ...
              <div className="bg-[#0c0d12] border border-border-theme rounded-xl p-4 w-full max-w-md text-left space-y-3 text-xs">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {/* Day Carousel */}
                <div className="relative flex items-center gap-1.5 bg-[#0c0d12] border border-border-theme p-3 rounded-xl">
                  <button
                    type="button"
                    onClick={prevCarousel}
                    disabled={carouselStartIdx === 0}
                    ...
                    {visibleDays.map(day => (
                      <button
                        ...
                        className={`py-2 px-1 text-center rounded-lg border flex flex-col items-center justify-center transition cursor-pointer ${
                          selectedDate === day.dateStr
                            ? 'bg-emerald-500 text-black border-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.35)]'
                            : 'bg-[#111218] hover:bg-[#1a1b24] border-border-theme text-slate-300'
                        }`}
                      >
                    ...
                    {slots.map(slot => (
                      <button
                        ...
                        className={`py-3 px-2 text-center rounded-lg border text-xs font-bold transition cursor-pointer ${
                          selectedTime === slot
                            ? 'bg-emerald-500 text-black border-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.35)] font-black'
                            : 'bg-[#0c0d12] hover:bg-[#13141e] border-border-theme text-slate-300'
                        }`}
                      >
                        {formatTimeSlot(slot)}
                      </button>
                ...
                <div className="space-y-5 pt-4 border-t border-white/5 animate-fade-in">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        value={form.name}
                        onChange={(e) => handleFieldChange('name', e.target.value)}
                        className="w-full rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 px-3 py-2.5 text-xs text-white placeholder-slate-600 focus:outline-none"
                        placeholder="Sarah Connor"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <input
                        ...
                        value={form.vehicle_year}
                        onChange={(e) => handleFieldChange('vehicle_year', e.target.value)}
                        className="rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 px-3 py-2.5 text-xs text-white placeholder-slate-600 focus:outline-none"
                        placeholder="Year"
                      />
                      <input
                        type="text"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={form.notes}
                      onChange={(e) => handleFieldChange('notes', e.target.value)}
                      className="w-full rounded-lg bg-[#0c0d12] border border-[#1e2028] focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/30 px-3 py-2.5 text-xs text-white placeholder-slate-600 focus:outline-none resize-none"
                  ...
                  {/* Summary of Selected Time Slot before booking */}
                  <div className="bg-[#0c0d12] border border-emerald-500/20 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs">
                    <div>
