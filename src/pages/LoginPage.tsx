...
import LoginCats3D from '../components/LoginCats3D';
...
export default function LoginPage({ onSuccess }: LoginPageProps) {
  ...
  return (
    ...
    >
      {/* Background full-viewport roaming cats */}
      <div className="fixed inset-0 z-0 pointer-events-none select-none overflow-hidden">
        <LoginCats3D />
      </div>

      <div className="w-full max-w-[420px] mx-auto flex flex-col items-center justify-between z-10 relative">
