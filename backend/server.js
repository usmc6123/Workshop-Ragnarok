...
app.post('/api/funnels', (req, res) => {
  try {
    const { slug, headline, subheadline, body, image_url, video_url, card_video_url, headline_bg_image_url, secondary_video_url, service_type, cta_text, active, layout } = req.body;
    ...
    const stmt = db.prepare(`
      INSERT INTO funnels (slug, headline, subheadline, body, image_url, video_url, card_video_url, headline_bg_image_url, secondary_video_url, service_type, cta_text, active, layout, user_id)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `);
    const info = stmt.run(
      cleanSlug, headline, subheadline || null, body || null, image_url || null, video_url || null, card_video_url || null,
      headline_bg_image_url || null, secondary_video_url || null,
  ...
  try {
    ...
    const stmt = db.prepare(`
      ...
      SET slug = ?, headline = ?, subheadline = ?, body = ?, image_url = ?, video_url = ?, card_video_url = ?,
          headline_bg_image_url = ?, secondary_video_url = ?,
